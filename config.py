...
#  D E F A U L T
    ...
    Key([mod], "r", lazy.spawn("/home/raciel/rofi/files/launchers/type-6/launcher.sh")),
    Key([mod], "l", lazy.spawn("/home/raciel/rofi/files/powermenu/type-6/powermenu.sh")),
...
# C U S T O M
    ...
    Key([], "XF86AudioMute", lazy.spawn("pamixer -t"), desc="Mute/Unmute volumen"),
    ...
    Key([mod], "c", lazy.spawn("spectacle"), desc="captura "),
]
...
layouts = [
    ...
    layout.MonadTall(**lay_config, border_focus='#a981d4',border_normal='#000000'),
...
def search():
    qtile.cmd_spawn("/home/raciel/rofi/files/launchers/type-6/launcher.sh")

def power():
    qtile.cmd_spawn("/home/raciel/rofi/files/powermenu/type-6/powermenu.sh")
...
def autostart():
    ...
    # (opcional) Lanzar el applet de Wi-Fi
